...
public interface PertenenciaRepository extends JpaRepository<Pertenencia, Long> {
    ...
    void actualizarPertenencia(@Param("id_invest") Long id_invest, @Param("pertenencia") String pertenencia);
    ...
    void agregarNuevaPertenencia(@Param("id_invest") Long id_invest, @Param("pertenencia") String pertenencia);
