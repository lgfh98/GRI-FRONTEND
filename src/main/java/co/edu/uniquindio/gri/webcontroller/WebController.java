		...
		if (Long.parseLong(id) != 0) {
			...
			case "u":
				...
				case "adm":
					...
					utilidades.seleccionarInvestigadoresPertenencia(investigadores, Util.PERTENENCIA_ADMINISTRATIVO);
					break;
				case "dp":
					investigadores = investigadorDAO.getAllInvestigadoresInternosFacultad(Long.parseLong(id));
					investigadores = utilidades.agregarPertenenciaInves(investigadores);
					utilidades.seleccionarInvestigadoresPertenencia(investigadores, Util.PERTENENCIA_DOCENTE_PLANTA);
					break;
				case "dc":
					investigadores = investigadorDAO.getAllInvestigadoresInternosFacultad(Long.parseLong(id));
					investigadores = utilidades.agregarPertenenciaInves(investigadores);
					utilidades.seleccionarInvestigadoresPertenencia(investigadores,
							Util.PERTENENCIA_DOCENTE_CATEDRATICO);
					break;
				case "do":
					investigadores = investigadorDAO.getAllInvestigadoresInternosFacultad(Long.parseLong(id));
					investigadores = utilidades.agregarPertenenciaInves(investigadores);
					utilidades.seleccionarInvestigadoresPertenencia(investigadores, Util.PERTENENCIA_DOCENTE_OCASIONAL);
					break;
				case "ie":
					investigadores = investigadorDAO.getAllInvestigadoresInternosFacultad(Long.parseLong(id));
					investigadores = utilidades.agregarPertenenciaInves(investigadores);
					utilidades.seleccionarInvestigadoresPertenencia(investigadores, Util.PERTENENCIA_EXTERNO);
					break;
				case "ei":
					investigadores = investigadorDAO.getAllInvestigadoresInternosFacultad(Long.parseLong(id));
					investigadores = utilidades.agregarPertenenciaInves(investigadores);
					utilidades.seleccionarInvestigadoresPertenencia(investigadores, Util.PERTENENCIA_ESTUDIANTE);
					break;
				case "ind":
					investigadores = investigadorDAO.getAllInvestigadoresInternosFacultad(Long.parseLong(id));
					investigadores = utilidades.agregarPertenenciaInves(investigadores);
					utilidades.seleccionarInvestigadoresPertenencia(investigadores, Util.PERTENENCIA_INDEFINIDO);
					break;
				default:
					investigadores = investigadorDAO.getAllInvestigadoresInternosFacultad(Long.parseLong(id));
			...
			case "dc":
				investigadores = investigadorDAO.getAllInvestigadoresInternos();
				investigadores = utilidades.agregarPertenenciaInves(investigadores);
				utilidades.seleccionarInvestigadoresPertenencia(investigadores, Util.PERTENENCIA_DOCENTE_CATEDRATICO);
				break;
			case "do":
				investigadores = investigadorDAO.getAllInvestigadoresInternos();
				investigadores = utilidades.agregarPertenenciaInves(investigadores);
